...
import '../drawer/drawer_menu.dart' show conversationsController, ConversationItem, showRenameSheet;
import '../apps/app_types.dart';
import '../apps/docs/docs_screen.dart';
              ...
              child: Column(
                ...
                children: [
                  ChatInput(
                    ...
                    onRecordingComplete: _onRecordingDone,
