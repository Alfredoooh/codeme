...
// ══════════════════════════════════════════════════════════════
// SPRING NAV (apenas slide, SEM recoil no conteúdo)
// ══════════════════════════════════════════════════════════════
...
class SpringNav {
  ...
  static const _desc = SpringDescription(mass: 1, stiffness: 260, damping: 28);
              ...
              Expanded(
                child: conversations.isEmpty
                    ...
                    : ListView.builder(
                        ...
                        itemBuilder: (_, i) => _ConvTile(s: s, item: conversations[i]),
                      ),
              ),
              Padding(
