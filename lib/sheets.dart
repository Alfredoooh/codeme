...
// ══════════════════════════════════════════════════════════════
// MODAL DE PROJETOS — vazio, sem mock
// ══════════════════════════════════════════════════════════════

class ProjectsModal extends StatelessWidget {
  final AppColorScheme s;
  const ProjectsModal({super.key, required this.s});
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      height: height,
      decoration: BoxDecoration(
        // pageBackground: cinza claro no light, escuro no dark — nunca branco puro
      ...
      child: Column(children: [
        ...
        Padding(
          ...
          child: Row(children: [
            Text('Projetos',
                style: TextStyle(
                    fontSize: 18, fontWeight: FontWeight.w700, color: s.onSurface)),
            const Spacer(),
            GestureDetector(
              onTap: () {},
              child: Container(
